...
var RestaurantDetailComponent = (function () {
    function RestaurantDetailComponent(restauranteService, route) {
        this.restauranteService = restauranteService;
        this.route = route;
    }
    RestaurantDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restauranteService.restaurantById(this.route.snapshot.params['id']).subscribe(function (restaurant) { return _this.restaurant = restaurant; });
    };
